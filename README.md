...
| <a name="input_index_document"></a> [index\_document](#input\_index\_document) | The name of the index document for the website | `string` | n/a | yes |
...
| <a name="input_redirect_all_requests_to"></a> [redirect\_all\_requests\_to](#input\_redirect\_all\_requests\_to) | Redirect all requests to another website | <pre>object({<br/>    host_name = string<br/>    protocol  = string<br/>  })</pre> | `null` | no |
...
| <a name="input_routing_rules"></a> [routing\_rules](#input\_routing\_rules) | List of routing rules for the website (optional) | <pre>list(object({<br/>    condition = object({<br/>      http_error_code_returned_equals = string<br/>      key_prefix_equals               = string<br/>    })<br/>    redirect = object({<br/>      host_name               = string<br/>      http_redirect_code      = string<br/>      protocol                = string<br/>      replace_key_prefix_with = string<br/>    })<br/>  }))</pre> | `[]` | no |
